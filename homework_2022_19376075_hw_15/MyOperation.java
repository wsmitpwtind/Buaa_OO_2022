...
public class MyOperation {
    ...
    private final HashMap<String, MyParameter> parameters;
    ...
    public void addNewParameter(MyParameter myParameter) {
        parameters.put(myParameter.getId(), myParameter);
        if (myParameter.getDirection() == Direction.IN) {
            this.inNameableType.add(myParameter.getType());
        }
        if (myParameter.getDirection() == Direction.RETURN) {
            this.outNameableType = myParameter.getType();
        }
    }
