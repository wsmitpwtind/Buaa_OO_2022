...
public class Adventurer implements ValueBody {
    ...
    public BigInteger getPrice() {
        ...
        for (ValueBody item : valueBodies) {
            ...
            setPrice(itemPrice);
            sumPrice = sumPrice.add(itemPrice);
        }
        setPrice(sumPrice);
        return sumPrice;
    }
    ...
    public void createAdventurer(Adventurer adventurer) {
        valueBodies.add(adventurer);
    }
    ...
    public void getEquipmentSituation(int equId) {
        for (ValueBody item : valueBodies) {
            if (item.getId() == equId) {
